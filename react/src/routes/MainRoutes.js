...
const AppFundraiserList = Loadable(lazy(() => import('views/application/customer/FundraiserList')));
...
const FrmLayoutAddFundraiser = Loadable(lazy(() => import('views/forms/layouts/AddFundraisersForm')));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/fundraiser/add-fundraiser',
            element: <FrmLayoutAddFundraiser />
        },
        {
