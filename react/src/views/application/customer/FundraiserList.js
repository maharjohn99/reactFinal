...
import { FUNDRAISERS } from 'gqloperations/queries';

// assets
import DeleteIcon from '@mui/icons-material/Delete';
import EditTwoToneIcon from '@mui/icons-material/EditTwoTone';
import FundraiserEdit from './FundraiserEditModal';
...
const FundraiserList = () => {
    const { data, loading, error } = useQuery(FUNDRAISERS);
    console.log(data);
    ...
    useEffect(() => {
        const fundraiserList = data?.fundraisers.map((items) => items);
        setRows(fundraiserList);
    }, [data]);
                            ...
                            <TableBody>
                                {stableSort(rows, getComparator(order, orderBy))
                                    ...
                                    .map((row, index) => {
                                        ...
                                        const isItemSelected = isSelected(row.fundraiserNameName);
